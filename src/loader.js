...
function startLoadScreen() {
  document.getElementById('visWindow').style.opacity = 0;
  document.getElementById('visWindow').style["pointer-events"] = 'none';
  document.getElementById('loader_container').style.position = 'fixed';
  loader();
}

function endLoadScreen() {
  document.getElementById('visWindow').style.opacity = 1;
  document.getElementById('visWindow').style["pointer-events"] = '';
